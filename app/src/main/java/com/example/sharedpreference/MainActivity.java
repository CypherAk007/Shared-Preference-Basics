...
//    Create sharedPreferences name and also crate key name
...
//        When open Activity first check  sharedPreferences data is available or Not

        String name = sharedPreferences.getString(KEY_NAME,null);
        if(name!= null){
//            if data is present directly call on HomeActivity...
